...
Insert into HocSinh (Ma_Hoc_Sinh,Ten_Hoc_Sinh,Username,Password,Role_Id,Ma_Lop,enabled) values (99998,N'Admin',N'admin',N'admin',99998,1,'Y');
Insert into HocSinh (Ma_Hoc_Sinh,Ten_Hoc_Sinh,Username,Password,Role_Id,Ma_Lop,enabled) values (99999,N'VuDaiK',N'user',N'user',99999,1,'Y');
